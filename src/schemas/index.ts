...
export const UnassignedForEnum = z.enum(["30m", "1h", "2h", "4h", "8h", "12h", "1d", "2d", "3d"]);
...
export const TicketBulkUpdateAction = z
  .object({
...
export const TicketBulkDeleteAction = z
  .object({
    ids: z.array(z.number().int()).min(1).max(100),
  })
  .passthrough();

export const TicketMerge = z
  .object({
...
export const ContactCreate = ContactBase.refine((v) => !!v.name, {
  message: "name is required",
}).refine((v) => !!v.email || !!v.phone || !!v.mobile || !!v.twitter_id || !!v.unique_external_id, {
  message: "Provide one of: email, phone, mobile, twitter_id, unique_external_id",
});

export const ContactUpdate = ContactBase;

export const ContactsMerge = z
  .object({
...
export const MakeAgentFields = z
  .object({
...
export const AgentCreate = AgentBase.refine((v) => !!v.email && v.ticket_scope !== undefined, {
...
).refine((v) => v.visibility !== 2 || (Array.isArray(v.group_ids) && v.group_ids.length > 0), {
  message: "group_ids required when visibility=2",
});

export const CannedResponseUpdate = CannedResponseBase;

export const CannedResponseFolderCreate = z
  .object({
    name: z.string(),
  })
  .passthrough();
...
export const SolutionCategoryCreate = SolutionCategoryBase.refine((v) => !!v.name, {
  message: "name is required",
});
export const SolutionCategoryUpdate = SolutionCategoryBase;

const SolutionFolderBase = z
  .object({
    name: z.string().optional(),
    description: z.string().optional(),
...
export const SolutionFolderCreate = SolutionFolderBase.refine((v) => !!v.name, {
  message: "name is required",
});
export const SolutionFolderUpdate = SolutionFolderBase;

const SolutionArticleBase = z
  .object({
    title: z.string().optional(),
    description: z.string().optional(),
...
const ForumCategoryBase = z
  .object({
    name: z.string().optional(),
    description: z.string().optional(),
  })
  .passthrough();
export const ForumCategoryCreate = ForumCategoryBase.refine((v) => !!v.name, {
  message: "name is required",
});
...
const ForumBase = z
  ...
  .passthrough();
export const ForumCreate = ForumBase.refine((v) => !!v.name && v.forum_type !== undefined, {
  message: "name and forum_type are required",
});
...
const TopicBase = z
  ...
  .passthrough();
export const TopicCreate = TopicBase.refine((v) => !!v.title && !!v.message_html, {
  message: "title and message_html are required",
});
...
const CommentBase = z
  ...
  .passthrough();
export const CommentCreate = CommentBase.refine((v) => !!v.body_html, {
...
const FieldChoice = z.union([
  z.string(),
  z
    .object({ value: z.union([z.string(), z.number()]), position: z.number().int().optional() })
    .passthrough(),
  z.record(z.any()),
]);

const TicketFieldBase = z
  .object({
  ...
  .passthrough();
export const TicketFieldCreate = TicketFieldBase.refine((v) => !!v.label && !!v.type, {
  message: "label and type are required",
});
export const TicketFieldUpdate = TicketFieldBase;

const ContactFieldBase = z
  .object({
    label: z.string().optional(),
    label_for_customers: z.string().optional(),
    type: z
...
const CompanyFieldBase = z
  ...
  .passthrough();
export const CompanyFieldCreate = CompanyFieldBase.refine((v) => !!v.label && !!v.type, {
  message: "label and type are required",
});
...
export const SatisfactionRatingCreate = z
  .object({
...
const MailboxBase = z
  ...
  .passthrough();
export const MailboxCreate = MailboxBase.refine((v) => !!v.name && !!v.support_email, {
  message: "name and support_email are required",
});
...
export const CustomObjectRecordCreate = z
  .object({
    data: z.record(z.any()),
  })
  .passthrough();
export const CustomObjectRecordUpdate = z
  .object({
...
const ServiceTaskBase = z
  ...
  .passthrough();
export const ServiceTaskCreate = ServiceTaskBase.refine((v) => !!v.title, {
...
const ThreadMessageBase = z
  ...
  .passthrough();
export const ThreadMessageCreate = ThreadMessageBase.refine((v) => !!v.body || !!v.body_text, {
  message: "body or body_text required",
});
export const ThreadMessageUpdate = ThreadMessageBase;

export const OutboundEmailCreate = z
  .object({
    subject: z.string(),
