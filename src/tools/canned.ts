...
export function registerCannedTools(server: McpServer) {
  tool(server, "list_canned_responses", "List canned responses in a folder.", { folder_id: z.number().int() }, async ({ folder_id }) => {
  ...
  tool(server, "view_canned_response", "View a canned response.", { canned_response_id: z.number().int() }, async ({ canned_response_id }) => {
  ...
  tool(server, "delete_canned_response", "Delete a canned response.", { canned_response_id: z.number().int() }, async ({ canned_response_id }) => {
  ...
  tool(server, "delete_canned_response_folder", "Delete a canned response folder.", { folder_id: z.number().int() }, async ({ folder_id }) => {
